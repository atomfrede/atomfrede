...
- [jhipster/jhipster-lite](https://github.com/jhipster/jhipster-lite) ([v0.33.0](https://github.com/jhipster/jhipster-lite/releases/tag/v0.33.0), 2 weeks ago) - JHipster Lite ⚡ is a development platform to generate, develop &amp; deploy modern web applications &amp; microservices architecture, step by step - using Hexagonal Architecture.
