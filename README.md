...
- [jhipster/jhipster-lite](https://github.com/jhipster/jhipster-lite) ([v0.36.0](https://github.com/jhipster/jhipster-lite/releases/tag/v0.36.0), 5 days ago) - JHipster Lite ⚡ is a development platform to generate, develop &amp; deploy modern web applications &amp; microservices architecture, step by step - using Hexagonal Architecture.
- [casid/jte](https://github.com/casid/jte) ([3.0.0](https://github.com/casid/jte/releases/tag/3.0.0), 1 week ago) - Secure and speedy templates for Java and Kotlin.
