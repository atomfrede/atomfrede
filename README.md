...
- [casid/jte](https://github.com/casid/jte) ([3.1.15](https://github.com/casid/jte/releases/tag/3.1.15), 2 weeks ago) - Secure and speedy templates for Java and Kotlin.
- [jhipster/jhipster-lite](https://github.com/jhipster/jhipster-lite) ([v1.22.0](https://github.com/jhipster/jhipster-lite/releases/tag/v1.22.0), 3 weeks ago) - JHipster Lite ⚡ is a development platform to generate, develop &amp; deploy modern web applications &amp; microservices architecture, step by step - using Hexagonal Architecture :gem:
